...
public class Triangle2 {
	...
	public Triangle2(double side1, double side2, double side3) throws Exception //triangle creator
	{
		this.s1=side1;
		this.s2=side2;
		this.s3=side3;
	...
	public Triangle2 (double side)//using 3 side method for equalateral triangle
	...
	public Triangle2(double side2, float angle, double side3)
	{
